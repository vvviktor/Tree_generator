...
int main() {
    ...
    std::ofstream a_balanced_bin_output("animated_balanced.svg");
    ...
    auto balanced_bin = tree_gen.BuildBalancedBin(v, 60);
    ...
    tree_rend.RenderAnimatedBFS(balanced_bin)
        .Render(a_balanced_bin_output);
}